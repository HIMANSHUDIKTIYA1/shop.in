        ...
        <section className="text-gray-600 body-font overflow-hidden">
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <img alt="ecommerce" className="lg:w-1/2 max-w-[500px] max-h-[500px] lg:h-auto object-cover  rounded" src={product.img} />
...
/>
                ...
                <div className="flex mt-4">
                  ...
                  <button id='heart' onClick={() => { document.getElementById("heart").style.color = 'orange'; }} onDoubleClick={() => { document.getElementById("heart").style.color = 'gray'; }} className="rounded-full ml-2 w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500">
