    ...
    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
      ...
      <div className="flex">
       ...
       <Link href='/checkout'><button  className="flex ml-4 text-white bg-orange-500 border-0 py-2 px-4 focus:outline-none hover:bg-orange-600 rounded">Buy</button></Link> 
        <button id='heart' onClick={() => { document.getElementById("heart").style.color = 'orange'; }} onDoubleClick={(check) => { document.getElementById("heart").style.color = 'gray'; }} className="rounded-full ml-2 w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500">
